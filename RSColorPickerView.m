...
- (void)layoutSubviews {
    self.layer.cornerRadius = round(CGRectGetWidth(self.bounds) / 2.f);
...
//    [self handleStateChanged];
    [self handleStateChangedDisableActionsWithoutColorChange:YES];
...
- (void)handleStateChangedDisableActionsWithoutColorChange:(BOOL)disable{
    [CATransaction begin];
